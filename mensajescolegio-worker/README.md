...
pnpm wrangler secret put SIEWEB_SCHOOL    # e.g. "santarosadelima"
pnpm wrangler secret put SIEWEB_USER      # SieWeb username
pnpm wrangler secret put SIEWEB_PASS      # SieWeb password
pnpm wrangler secret put HERMES_API_KEY   # API key that Hermes sends in X-API-Key header
```
